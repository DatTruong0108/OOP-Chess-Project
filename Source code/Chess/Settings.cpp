...
namespace utilities {
    ...
    // rgba(83,83,172,255)
    Color Settings::_blackSquareColor = Color(83, 83, 172, 200);
    // rgba(208,207,249,255)
    Color Settings::_whiteSquareColor = Color(208, 207, 249, 255);
    ...
    void Settings::updateCellSize(const Vector2u& windowSize) {
        ...
        Settings::_cellSize = std::min(windowSize.y, windowSize.y) / 8;

        Settings::_cellOffset.x = (windowSize.y - Settings::_cellSize * 8) / 2;
        Settings::_cellOffset.y = (windowSize.y - Settings::_cellSize * 8) / 2;
    }
}